...
git clone --depth=1 https://github.com/Shubhendu-XD/android_kernel_asus_X00P -b lineage-18.x kernel
cd kernel
...
TANGGAL=$(date +"%F-%S")
TOKEN="5096348570:AAG7Q303c2uzWyi4I1oGND6uA0EuS8gO2-A"
chat_id=-1001596395081
START=$(date +"%s")
